    ...
    return (
      ...
      <div className="relative h-64 w-9/10 mx-auto my-4">
        ...
        { edges.s3_chou_ef_vote > 0 ? (
          ...
          <tbody>
                <tr>
                    <td className="w-1/2 px-2 bg-gray-200 border-b-2">当選者得票数</td>
                    <td className="text-right w-34 px-2 border-b-2">無投票当選</td>
                </tr>
                <tr>
                    <td className="w-1/2 px-2 bg-gray-200 border-b-2">連続在任期</td>
                    <td className="text-right w-34 px-2 border-b-2">{edges.s3_chou_re_elected}</td>
                </tr>
                <tr>
                    <td className="w-1/2 px-2 bg-gray-200 border-b-2">首長任期</td>
                    <td className="text-right w-34 px-2 border-b-2">{edges.s3_chou_ninki}</td>
                </tr>
          </tbody>
          </table>
        </div>
